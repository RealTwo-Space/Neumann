 ...
 * created 1/11/17
 */
public class NablaOperation extends Operation{
    private BinomialArgument arg;
    private DECondition cond;

    public NablaOperation(Node U, Node dx, DECondition cond) {
    ...
    public Data execute() {
        if (this.arg.getDataAt(0).get() instanceof Matrix64 && this.arg.getDataAt(1).get() instanceof Double) {
            ...
            Matrix64 output = DiffEq64.nabla(u, (double)dx, this.cond.getCondition());
